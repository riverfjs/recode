...
# Datasets
parser.add_argument('-train', '--trainroot', default='/content/drive/MyDrive/new_shu_label.txt', type=str) #new_shu_label
parser.add_argument('-val', '--valroot', default='/content/drive/MyDrive/val1.txt', type=str)
